...
-- Fingerprinting protocol for SSL
...
cgs_ssl_proto.fields = {osfinger_ssl_full_name_F, osfinger_ssl_os_name_F, osfinger_ssl_os_class_F, osfinger_ssl_os_vendor_F, osfinger_ssl_device_type_F, osfinger_ssl_device_vendor_F}
...
-- Preload Satori's SSL signatures
...
function cgs_ssl_proto.dissector(buffer, pinfo, tree)
    ...
    and (ssl_ja3_signature ~= nil
        ...
        if osfinger.ssl_stream_table[cur_stream_id] == nil then
            ...
            osfinger.ssl_stream_table[cur_stream_id]["port_pair"] = {
...
register_postdissector(cgs_ssl_proto)

return osfinger_ssl_dissector
